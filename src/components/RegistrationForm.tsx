...
// Email sending is handled by Netlify functions
...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // First validate the email using our Netlify function
      ...
      if (validationResponse.status !== 200) {
        throw new Error(
          validationResponse.data.message || "Email validation failed",
        );
      }
      ...
      // OTP email is sent by the backend Netlify function
